		...
		<PageContainer>
			...
			<div className='fww-con'>
				...
				<main className="fww-main" data-layout="usr">
					<h1 className="tx tx-hd2">수요조사 지원 내용 수정</h1>
						...
						<form className="fo fo-col2" name="" action="" method="">
							<div className="inner">
								...
								<div className="fo-item req">
									...
									<div className="fo-value">
										<UIInput className={'tf tf-md w100p'} value={'대리'} placeholder={'직함을 입력하세요'} />
									</div>
								</div>
								<div className="fo-item req">
									<p className="fo-key">연락처</p>
									<div className="fo-value">
										<UIInput className={'tf tf-md w100p'} value={'0222222222'} placeholder={'연락처를 입력하세요(- 생략)'} />
									</div>
								</div>
								<div className="fo-item">
									<p className="fo-key">휴대폰번호</p>
									<div className="fo-value">
										<UIInput className={'tf tf-md w100p'} value={'01000000000'} placeholder={'휴대폰번호를 입력하세요(- 생략)'} />
									</div>
								</div>
								<div className="fo-item  fo-m-1-3 req">
									...
									<div className="fo-value">
										<div className="hz-root hz-gap5 w565">
											<UIInput className={'hz-item hz-fg tf tf-md'} value={'mailID'} placeholder={'메일계정 입력'} />	
											<span>@</span>
											<UIInput className={'hz-item hz-fg tf tf-md'} value={'mail.com'} placeholder={'메일주소 입력'} />	
						...
						<form className="fo fo-col2" name="" action="" method="">
							<div className="innter">
								<div className="fo-item fo-m-1-3 req">
									...
									<div className="fo-value">
										<UIInput className={'tf tf-md w100p'} value={'신청제목출력'} placeholder={'신청제목을 입력하세요.'} />
									</div>
								</div>
								...
								<div className="fo-item fo-m-1-3">
									...
									<div className="fo-value">
										<div className="fund-form-items tf-unit">
											<UIInput className={'tf tf-md ta-right'} value={'000,000,000'} placeholder={'상생협력기금으로 사용할 금액을 입력하세요.'}  />
