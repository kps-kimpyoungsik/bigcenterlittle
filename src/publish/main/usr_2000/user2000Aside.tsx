...
function PortalAside() {
	...
	return (
		<aside className='fww-aside'>
			...
			<ul className='d1'>
				<li className={location.pathname === '/main/usr_2000/usr_2000' ? 'active' : ''}>
					<Link to="/main/usr_2000/usr_2000">출연신청</Link>
				</li>
				<li className={location.pathname === '/main/usr_2000/usr_2002' || location.pathname === '/main/usr_2000/usr_2004' || location.pathname === '/main/usr_2000/usr_2006' ? 'active' : ''}>
					<Link to="/main/usr_2000/usr_2002">출연현황</Link>
				</li>
				<li className={location.pathname === '/main/usr_2000/usr_2007' ? 'active' : ''}>
					<Link to="/main/usr_2000/usr_2007">전용신청</Link>
				</li>
				<li className={location.pathname === '/main/usr_2000/usr_2009' || location.pathname === '/main/usr_2000/usr_2011' || location.pathname === '/main/usr_2000/usr_2012' ? 'active' : ''}>
