					...
					<form className="fo fo-col2" name="" action="" method="">
						<div className="inner">
							...
							<div className="fo-item req">
								...
								<div className="fo-value">
									<UIInput type={'number'} className={'tf tf-md w100p'} value={''} placeholder={'-없이 숫자만 입력'}/>
								</div>						
							</div>
							<div className="fo-item req"> 
							...
							<div className="fo-item fo-m-1-3">
								...
								<div className="fo-value">
									<div className="hz-root hz-gap8">
										<UIInput className={'hz-item tf tf-md w120'} value={''} placeholder={'우편번호'}/>
										<UIInput className={'hz-item tf tf-md hz-fg'} value={''} placeholder={'주소'}/>
