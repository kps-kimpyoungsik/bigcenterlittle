			...
			<LayoutAside />
				...
				<div className="fww-con">
					...
					<ul className="fww-brd">
						...
						<li className=""><a href="">한도금액통제</a></li>
					</ul>
					...
					<main className="fww-main">
							...
							<div className="inner">
								<div className="sf-item">
									...
									<div className="sf-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="" placeholder="이름/아이디" />
									</div>						
								</div>							
							</div> 
						...
						<div className="tb-top">
							...
							<div className="hz-root hz-gap5">
								<button className="bt bt-sm bt-gray-o" type="button">한도금액 등록</button>
