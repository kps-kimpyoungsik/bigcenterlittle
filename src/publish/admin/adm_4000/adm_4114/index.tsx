						...
						<div className="fo fo-col2">
							<div className="inner">
								...
								<div className="fo-item req">
									...
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="관리자" placeholder="사용자명" />
									</div>						
								</div>
								<div className="fo-item req">
								...
								<div className="fo-item req">
									...
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="대리" placeholder="직급" />
									</div>						
								</div>
								<div className="fo-item req">
									<p className="fo-key">휴대폰번호</p>
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="010-1111-2222" placeholder="-없이 숫자만" />
									</div>						
								</div>
								<div className="fo-item req">
									<p className="fo-key">이메일</p>
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="email" pattern="[a-zA-Z0-9]+[@][a-zA-Z0-9]+[.]+[a-zA-Z]+[.]*[a-zA-Z]*" value="admin@email.com" placeholder="이메일" />
									</div>						
								</div>
								<div className="fo-item">
									<p className="fo-key">사무실전화번호</p>
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="02-1111-2222" placeholder="-없이 숫자만" />
									</div>						
								</div>
								...
								<div className="fo-item">
									...
									<div className="fo-value">
										<input readOnly name="" id="" className="tf tf-md w100p" type="text" value="아니오" placeholder="이메일 인증" />
									</div>
								</div>
								<div className="fo-item">
									<p className="fo-key">인증일시</p>
									<div className="fo-value">
										<input readOnly name="" id="" className="tf tf-md w100p" type="text" value="YYYY-MM-DD HH:MM:SS" placeholder="인증일시" />
									</div>
								</div>
								<div className="fo-item">
									<p className="fo-key">비밀번호오류횟수</p>
									<div className="fo-value">
										<input readOnly name="" id="" className="tf tf-md w100p" type="number" value="0" placeholder="비밀번호오류횟수" />
									</div>
								</div>
								...
								<div className="fo-item">
									...
									<div className="fo-value">
										<input readOnly name="" id="" className="tf tf-md w100p" type="text" value="YYYY-MM-DD HH:MM:SS" placeholder="등록일시" />
									</div>
								</div>								
