						...
						<div className="fo fo-col2">
							<div className="inner">
								...
								<div className="fo-item">
									...
									<div className="fo-value">
										<input readOnly name="" id="" className="tf tf-md w100p" type="text" value="123-12345-11-123" placeholder="계좌번호" />
									</div>						
								</div>
								<div className="fo-item req"> 
									<p className="fo-key">사업자등록번호</p>
									<div className="fo-value">
										<input readOnly name="" id="" className="tf tf-md w100p" type="text" value="123-12-12345" placeholder="-없이 숫자만 입력" />
									</div>
								</div>
								<div className="fo-item req">
									<p className="fo-key">기업명</p>
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="대·중소기업·농어업협력재단" placeholder="기업명" />
									</div>						
								</div>
								<div className="fo-item req">
									<p className="fo-key">대표자명</p>
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="홍길동" placeholder="대표자명" />
									</div>						
								</div>
								<div className="fo-item"> 
								...
								<div className="fo-item">
									...
									<div className="fo-value">
										<input name="" id="" className="tf tf-md w100p" type="text" value="" placeholder="집단" />
									</div>						
								</div>
								<div className="fo-item"> 
								...
								<div className="fo-item">
									...
									<div className="fo-value">
										<input  name="" id="" className="tf tf-md w100p" type="text" value="http://www.abcd1234page.com/kr/index.do" placeholder="홈페이지" />
									</div>						
								</div>
								<div className="fo-item fo-m-1-3">
									...
									<div className="fo-value">
										<div className="hz-root hz-gap8">
											<input readOnly name="" id="" className="hz-item tf tf-md w120" type="text" value="12345" placeholder="" />
											<input readOnly name="" id="" className="hz-item tf tf-md hz-fg" type="text" value="서울특별시 중구 퇴계로 173" placeholder="" />
