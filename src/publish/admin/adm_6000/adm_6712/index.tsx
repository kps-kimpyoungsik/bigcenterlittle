					...
					<form className="fo fo-col2" name="" action="" method="">
						<div className="inner">
							<div className="fo-item fo-m-1-3  req">
								...
								<UIInput className={'tf tf-md w375'} value={'123-12-12345'} placeholder={''}/>
								</div>
							</div>
							<div className="fo-item fo-m-1-3  req">
								<p className="fo-key">사업장</p>
								<div className="fo-value">
									<UIInput className={'tf tf-md w100p'} value={'대중소농어업협력재단'} placeholder={''}/>
								</div>
							</div>
							<div className="fo-item fo-m-1-3  req">
								<p className="fo-key">펌뱅킹 별칭</p>
								<div className="fo-value">
									<UIInput  className={'tf tf-md w100p'} value={'상생협력기금'} placeholder={''}/>
								</div>
							</div>
							<div className="fo-item fo-m-1-3  req">
							...
							<div className="fo-item fo-m-1-3  req">
								...
								<div className="fo-value">
									<UIInput className={'tf tf-md w375'} value={'00001234'} placeholder={''}/>
								</div>
							</div>
							<div className="fo-item fo-m-1-3  req">
